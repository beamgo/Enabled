...
<head>
    ...
    <title>หน้าหลัก - ผู้ประกอบการ</title>
...
<body><?php include 'c-navigation.php';?>
    ...
    <!-- Brand and toggle get grouped for better mobile display -->
        <form class="navbar-form navbar-right" action="c-checklogin.php" method="post">
            <div class="form-group">
            อีเมลล์ : <input name="cemail" type="text" class="form-control" placeholder="email ผู้ประกอบการ">&nbsp;
            รหัสผ่าน : <input name="cpassword" class="form-control" type="password" required placeholder="รหัสผ่าน 8 - 15 ตัวอักษร">
            ...
            ยังไม่ได้เป็นสมาชิก? 
            &nbsp;&nbsp;
            <a href="c-register.php"> สมัครสมาชิกที่นี่</a>
        </form> 
        </div><!-- /.navbar-collapse -->
        </nav>
        </div><!-- .row -->
...
<div class="container" style="background-image: url(banner-bg.jpg); height: 70%; width: 100%;"><font color="#FFFFFF">
    ...
    <div class="col-lg-4">
        <br><br><br><br>              
        <h3>ค้นหาคนพิการที่ต้องการ </h3><br>
        </div></div>
        <div class="row">
            <div class="col-lg-2">
            </div>
	...
	<form method="post" action="c-warnlogin.php">
    ...
    <?php
                ...
                <p align="right">
                           <button class="btn btn-default btn-lg"><a href="c-warnlogin.php">รายละเอียดเพิ่มเติม</a></button></p>
                </div>
                </div></div></div>
    <?php
            }?>          
