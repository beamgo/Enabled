...
<body background="banner-bg.jpg">  
    <div class="container">
        ...
        <div class="row">
          ...
          <form method="post" action="p-checkreg.php">
          <h3 style="padding-bottom:8px; padding-top:3px"><center><font color="#5C5C5C">คนพิการ</font></center></h3>
          อีเมล์ :
          <input name="pemail" type="email" required autofocus style="border:2px #D4D6DD solid" class="form-control"><br>
          รหัสผ่าน :
          <input name="ppassword" type="password" required placeholder="รหัสผ่าน 8 - 15 ตัวอักษร" maxLength="15" style="border:2px #D4D6DD solid; border-radius:4px" class="form-control"><br>
          ยืนยันรหัสผ่าน :
