    ...
    <div class="row">
       ...
       <!-- <input name="pid" type="hidden" value="<//?php echo $_POST["pid"]; ?>" > -->
        ...
        ?>
         ...
         <form method="post" action="p-edit-6-1.php" enctype="multipart/form-data"> 
        ...
        <form  method="post" action="p-edit-6-2.php" enctype="multipart/form-data">
            <div class="row">
        ...
        <br><br>
         ...
         <div class="row">
                    ...
                    <button><a href="p-edit-completed.php" >บันทึก</a></button>
                    <br><br>
                    </div>
                </div>
