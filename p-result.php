...
<body>
<br><br><br>
    <form method="post" action="p-result.php">
...
<div class="container">
	<div class="row">
    	<ul class="nav nav-tabs">
 		<li role="presentation" class="active"><a >ค้นหางานที่ต้องการ</a></li>
		</ul>
		<br><br>
        ...
        <br><br><br>
        <a href="p-result.php"><button type="submit">ค้นหา</button></a>
     ...
     -------------------------------------
       ...
       <!-- ค่าค้นหาที่รับเข้ามา-->
        ...
        if($_POST["jtype"] !== ""){
            ...
            $strSQL = "SELECT * FROM jobpost WHERE jtype = '$jtype'";
            $ch=1;
        ...
        if($_POST["jposi"] !== ""){
            ...
            if($ch>0){
                ...
                $strSQL = "$strSQL And jposi='$jposi'";
            }
            else{
                
            $strSQL = "SELECT * FROM jobpost WHERE jposi = '$jposi'";
            $ch=1;
        ...
        if($_POST["jdistype"] !== ""){
            ...
            if($ch>0){
                ...
                $strSQL = "$strSQL And jdistype='$jdistype'";
            }
            else{
                
            $strSQL = "SELECT * FROM jobpost WHERE jdistype = '$jdistype'";
            $ch=1;
        ...
        if($_POST["jedu"] !== ""){
             ...
             if($ch>0){
                ...
                $strSQL = "$strSQL And jedu='$jedu'";
            }
            else{
                
            $strSQL = "SELECT * FROM jobpost WHERE jedu = '$jedu'";
            $ch=1;
        ...
        if($_POST["jprovince"] !== ""){
             ...
             if($ch>0){
                ...
                $strSQL = "$strSQL And jprovince='$jprovince'";
            }
            else{
                
            $strSQL = "SELECT * FROM jobpost WHERE jprovince = '$jprovince'";
            $ch=1;
