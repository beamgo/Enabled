...
<div class="container">
    <div class="row">
        ...
        <div class="container">
        <form method="post" action="register-5-process.php" enctype="multipart/form-data">
	 	 ...
	 	 <select name="distype" required>
             ...
             <div class="row">
                    ...
                    <br><div class="form-group">
                        <input name="disdetail" type="text" class="form-control">
                        </div>
                </div>
                </div>    
           ...
           <!-- /.row -->
                <div class="row">
                    ...
                    <div class="col-lg-3">
                      ...
                      <input name="disaid" type="text" class="form-control">
                    </div>
                </div>
                </div>
