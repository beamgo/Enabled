...
<div class="container">
  ...
  <div class="accordion-tab" id="accordion2">
    ...
    <div class="container">
        <div class="col-sm-12">
          <h4>ระดับปานกลาง</h4>
          <p>ทักษะการใช้คอมพิวเตอร์ในระดับปานกลาง เหมาะสำหรับผู้ที่มีพื้นฐานด้านคอมพิวเตอร์เบื้องต้นเป็นอย่างดี โดยในระดับนี้ประกอบไปด้วยทักษะต่างๆที่ต้องใช้ความรู้ความเข้าใจโปรแกรมพื้นฐานต่างๆมาประยุกต์ใช้ และสามารถนำไปประกอบอาชีพต่างๆได้มากมาย</p>
        </div>
    </div>
...
<div class="accordion-tab" id="accordion3">
  ...
  <div class="container">
      <div class="col-sm-12">
        <h4>ระดับสูง</h4>
        <p>ทักษะด้านไอทีในระดับสูงนี้ เหมาะสำหรับผู้ที่มีพื้นฐานคอมพิวเตอร์ค่อนข้างดีมาก เพราะเป็นทักษะที่ต้องใช้การคิดวิเคราะห์ การวางแผนและประยุกต์ใช้ความรู้ต่างๆค่อนข้างมาก ซึ่งผลตอบแทนหรือรายได้ของผู้ที่มีความสามารถเหล่านี้ก็มากเช่นกัน</p>
      </div>
  </div>
